...
<?php $mb_order = $settings['mobile_order']; ?>


<section class="two-column bg bg--<?php echo $bg_color; ?>" <?php if ($row_id) {echo 'id="'. $row_id.'"';}; ?>>
	<div class="container">
		<div class="row align-items-<?php echo $align; ?> padding--<?php echo $padding; ?>">
			...
			<?php endif; ?>
			<div class="col-md-6 <?php if ($mb_order == 'flip') : echo 'mobile-order-last'; endif; ?>">
			...
			<div class="col-md-6 <?php if ($mb_order == 'flip') : echo 'mobile-order-first'; endif; ?>">
